...
const ProfilePaginationPage = ({page, total, onHandlePreviousPage, onHandleNextPage}) => {
    return (
        <div className="flex justify-center">
            ...
            <span className='flex items-center justify-center px-4 h-10 text-base font-medium text-gray-500'>Page {page} of {total}</span>
...
export default ProfilePaginationPage;